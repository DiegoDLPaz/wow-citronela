...
export const data: TalentData = {
  "Beast Mastery": {
    name: "Beast Mastery",
    background: bg("beast-mastery"),
    icon: ic("ability_hunter_beasttaming"),
    talents: {
      "Improved Aspect of the Hawk": {
        name: "Improved Aspect of the Hawk",
        pos: "a2",
        icon: ic("spell_nature_ravenform"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Endurance Training": {
        ...
        pos: "a3",
        icon: ic("spell_nature_reincarnation"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Improved Aspect of the Monkey": {
        ...
        pos: "b2",
        icon: ic("ability_hunter_aspectofthemonkey"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Improved Revive Pet": {
        ...
        pos: "b4",
        icon: ic("ability_hunter_beastsoothe"),
        maxRank: 2,
        reqPoints: 5,
      ...
      Pathfinding: {
        name: "Pathfinding",
        pos: "c1",
        icon: ic("ability_mount_jungletiger"),
        maxRank: 2,
        reqPoints: 10,
      ...
      "Improved Mend Pet": {
        ...
        pos: "d2",
        icon: ic("ability_hunter_mendpet"),
        maxRank: 2,
        reqPoints: 15,
      ...
      Ferocity: {
        name: "Ferocity",
        pos: "d3",
        icon: ic("inv_misc_monsterclaw_04"),
        maxRank: 5,
        reqPoints: 15,
      ...
      "Spirit Bond": {
        name: "Spirit Bond",
        pos: "e1",
        icon: ic("ability_druid_demoralizingroar"),
        maxRank: 2,
        reqPoints: 20,
      ...
      "Bestial Discipline": {
        ...
        pos: "e4",
        icon: ic("spell_nature_abolishmagic"),
        maxRank: 2,
        reqPoints: 20,
      ...
      Frenzy: {
        name: "Frenzy",
        pos: "f3",
        icon: ic("inv_misc_monsterclaw_03"),
        maxRank: 5,
        reqPoints: 25,
        prereq: "Ferocity",
      ...
      "Bestial Wrath": {
        name: "Bestial Wrath",
        pos: "g2",
        icon: ic("ability_druid_ferociousbite"),
        maxRank: 1,
        reqPoints: 30,
        prereq: "Intimidation",
  ...
  Marksmanship: {
    name: "Marksmanship",
    background: bg("marksmanship"),
    icon: ic("ability_marksmanship"),
    talents: {
      "Improved Concussive Shot": {
        name: "Improved Concussive Shot",
        pos: "a2",
        icon: ic("spell_frost_stun"),
        maxRank: 5,
        reqPoints: 0,
      ...
      Efficiency: {
        name: "Efficiency",
        pos: "a3",
        icon: ic("spell_frost_wizardmark"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Improved Hunter's Mark": {
        ...
        pos: "b2",
        icon: ic("ability_hunter_snipershot"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Improved Serpent Sting": {
        ...
        pos: "d2",
        icon: ic("ability_hunter_quickshot"),
        maxRank: 5,
        reqPoints: 15,
      ...
      "Scatter Shot": {
        name: "Scatter Shot",
        pos: "e1",
        icon: ic("ability_golemstormbolt"),
        maxRank: 1,
        reqPoints: 20,
      ...
      Barrage: {
        name: "Barrage",
        pos: "e2",
        icon: ic("ability_upgrademoonglaive"),
        maxRank: 3,
        reqPoints: 20,
      ...
      "Improved Scorpid Sting": {
        ...
        pos: "e3",
        icon: ic("ability_hunter_criticalshot"),
        maxRank: 3,
        reqPoints: 20,
  ...
  Survival: {
    name: "Survival",
    background: bg("survival"),
    icon: ic("ability_hunter_swiftstrike"),
    talents: {
      "Monster Slaying": {
        name: "Monster Slaying",
        pos: "a1",
        icon: ic("inv_misc_head_dragon_black"),
        maxRank: 3,
        reqPoints: 0,
      ...
      "Humanoid Slaying": {
        ...
        pos: "a2",
        icon: ic("spell_holy_prayerofhealing"),
        maxRank: 3,
        reqPoints: 0,
      ...
      Entrapment: {
        name: "Entrapment",
        pos: "b1",
        icon: ic("spell_nature_stranglevines"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Savage Strikes": {
        name: "Savage Strikes",
        pos: "b2",
        icon: ic("ability_racial_bloodrage"),
        maxRank: 2,
        reqPoints: 5,
      ...
      "Improved Feign Death": {
        ...
        pos: "d4",
        icon: ic("ability_rogue_feigndeath"),
        maxRank: 2,
        reqPoints: 15,
      ...
      "Killer Instinct": {
        ...
        pos: "e2",
        icon: ic("spell_holy_blessingofstamina"),
        maxRank: 3,
        reqPoints: 20,
      ...
      Counterattack: {
        name: "Counterattack",
        pos: "e3",
        icon: ic("ability_warrior_challange"),
        maxRank: 1,
        reqPoints: 20,
        prereq: "Deterrence",
      ...
      "Lightening Reflexes": {
        ...
        pos: "f3",
        icon: ic("spell_nature_invisibilty"),
        maxRank: 5,
        reqPoints: 25,
