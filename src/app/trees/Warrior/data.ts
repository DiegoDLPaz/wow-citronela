...
export const data: TalentData = {
  Arms: {
    ...
    talents: {
      ...
      "Improved Charge": {
        ...
        pos: "b1",
        icon: ic("ability_warrior_charge"),
        maxRank: 2,
        reqPoints: 5,
      ...
      "Mortal Strike": {
        name: "Mortal Strike",
        pos: "g2",
        icon: ic("ability_warrior_savageblow"),
        maxRank: 1,
        reqPoints: 30,
  ...
  Fury: {
    name: "Fury",
    background: bg("fury"),
    icon: ic("ability_warrior_innerrage"),
    talents: {
      "Booming Voice": {
        name: "Booming Voice",
        pos: "a2",
      ...
      "Improved Cleave": {
        ...
        pos: "c1",
        icon: ic("ability_warrior_cleave"),
        maxRank: 3,
        reqPoints: 10,
      ...
      "Improved Battle Shout": {
        ...
        pos: "c4",
        icon: ic("ability_warrior_battleshout"),
        maxRank: 5,
        reqPoints: 10,
      ...
      "Improved Berserker Rage": {
        ...
        pos: "f1",
        icon: ic("spell_nature_ancestralguardian"),
        maxRank: 2,
        reqPoints: 25,
      ...
      Bloodthirst: {
        name: "Bloodthirst",
        pos: "g2",
        icon: ic("spell_nature_bloodlust"),
        maxRank: 1,
        reqPoints: 30,
        prereq: "Death Wish",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
  ...
  Protection: {
    ...
    talents: {
      ...
      "Last Stand": {
        name: "Last Stand",
        pos: "c1",
        icon: ic("spell_holy_ashestoashes"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Improved Revenge": {
        ...
        pos: "c3",
        icon: ic("ability_warrior_revenge"),
        maxRank: 3,
        reqPoints: 10,
      ...
      "Improved Sunder Armor": {
        ...
        pos: "d1",
        icon: ic("ability_warrior_sunder"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Improved Disarm": {
        ...
        pos: "d2",
        icon: ic("ability_warrior_disarm"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Improved Shield Wall": {
        ...
        pos: "e1",
        icon: ic("ability_warrior_shieldwall"),
        maxRank: 2,
        reqPoints: 20,
      ...
      "Improved Shield Bash": {
        ...
        pos: "e3",
        icon: ic("ability_warrior_shieldbash"),
        maxRank: 2,
        reqPoints: 20,
