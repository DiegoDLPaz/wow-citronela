...
export const data: TalentData = {
  Affliction: {
    name: "Affliction",
    background: bg("affliction"),
    icon: ic("spell_shadow_deathcoil"),
    talents: {
      Suppression: {
        name: "Suppression",
        pos: "a2",
      ...
      "Improved Corruption": {
        ...
        pos: "a3",
        icon: ic("spell_shadow_abominationexplosion"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Improved Curse of Weakness": {
        ...
        pos: "b1",
        icon: ic("spell_shadow_curseofmannoroth"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Improved Drain Life": {
        ...
        pos: "b4",
        icon: ic("spell_shadow_lifedrain02"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Improved Curse of Agony": {
        ...
        pos: "c1",
        icon: ic("spell_shadow_curseofsargeras"),
        maxRank: 3,
        reqPoints: 10,
      ...
      "Fel Concentration": {
        ...
        pos: "c2",
        icon: ic("spell_shadow_fingerofdeath"),
        maxRank: 5,
        reqPoints: 10,
        description: talentText`Gives you a ${[
          14,
      ...
      "Amplify Curse": {
        name: "Amplify Curse",
        pos: "c3",
        icon: ic("spell_shadow_contagion"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Grim Reach": {
        name: "Grim Reach",
        pos: "d1",
        icon: ic("spell_shadow_callofbone"),
        maxRank: 2,
        reqPoints: 15,
      ...
      "Shadow Mastery": {
        name: "Shadow Mastery",
        pos: "f2",
        icon: ic("spell_shadow_shadetruesight"),
        maxRank: 5,
        reqPoints: 25,
        prereq: "Siphon Life",
      ...
      "Dark Pact": {
        name: "Dark Pact",
        pos: "g2",
        icon: ic("spell_shadow_darkritual"),
        maxRank: 1,
        reqPoints: 30,
  ...
  Demonology: {
    name: "Demonology",
    background: bg("demonology"),
    icon: ic("spell_shadow_metamorphosis"),
    talents: {
      "Improved Healthstone": {
        name: "Improved Healthstone",
        pos: "a1",
        icon: ic("inv_stone_04"),
        maxRank: 2,
        reqPoints: 0,
      ...
      "Improved Imp": {
        name: "Improved Imp",
        pos: "a2",
        icon: ic("spell_shadow_summonimp"),
        maxRank: 3,
        reqPoints: 0,
      ...
      "Improved Voidwalker": {
        ...
        pos: "b2",
        icon: ic("spell_shadow_summonvoidwalker"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Fel Intellect": {
        name: "Fel Intellect",
        pos: "b3",
        icon: ic("spell_holy_magicalsentry"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Fel Domination": {
        name: "Fel Domination",
        pos: "c2",
        icon: ic("spell_nature_removecurse"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Improved Enslave Demon": {
        ...
        pos: "e1",
        icon: ic("spell_shadow_enslavedemon"),
        maxRank: 5,
        reqPoints: 20,
      ...
      "Master Demonologist": {
        ...
        pos: "f3",
        icon: ic("spell_shadow_shadowpact"),
        maxRank: 5,
        reqPoints: 25,
        prereq: "Unholy Power",
      ...
      "Improved Spellstone": {
        ...
        pos: "g3",
        icon: ic("inv_misc_gem_sapphire_01"),
        maxRank: 2,
        reqPoints: 30,
  ...
  Destruction: {
    name: "Destruction",
    background: bg("destruction"),
    icon: ic("spell_shadow_rainoffire"),
    talents: {
      "Improved Shadow Bolt": {
        name: "Improved Shadow Bolt",
        pos: "a2",
        icon: ic("spell_shadow_shadowbolt"),
        maxRank: 5,
        reqPoints: 0,
      ...
      Bane: {
        name: "Bane",
        pos: "b2",
        icon: ic("spell_shadow_deathpact"),
        maxRank: 5,
        reqPoints: 5,
      ...
      Shadowburn: {
        name: "Shadowburn",
        pos: "c4",
        icon: ic("spell_shadow_scourgebuild"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Destructive Reach": {
        ...
        pos: "d2",
        icon: ic("spell_shadow_corpseexplode"),
        maxRank: 2,
        reqPoints: 15,
      ...
      Emberstorm: {
        name: "Emberstorm",
        pos: "f3",
        icon: ic("spell_fire_selfdestruct"),
        maxRank: 5,
        reqPoints: 25,
