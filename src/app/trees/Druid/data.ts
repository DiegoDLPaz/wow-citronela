...
export const data: TalentData = {
  Balance: {
    name: "Balance",
    background: bg('balance'),
    icon: ic('spell_nature_starfall'),
    talents: {
      "Improved Wrath": {
        name: "Improved Wrath",
        pos: "a1",
      ...
      "Nature's Grasp": {
        name: "Nature's Grasp",
        pos: "a2",
        icon: ic("spell_nature_natureswrath"),
        maxRank: 1,
        reqPoints: 0,
      ...
      "Natural Shapeshifter": {
        ...
        pos: "b4",
        icon: ic("spell_nature_wispsplode"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Omen of Clarity": {
        ...
        pos: "c3",
        icon: ic("spell_nature_crystalball"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Nature's Reach": {
        name: "Nature's Reach",
        pos: "c4",
        icon: ic("spell_nature_naturetouchgrow"),
        maxRank: 2,
        reqPoints: 10,
      ...
      "Nature's Grace": {
        name: "Nature's Grace",
        pos: "e2",
        icon: ic("spell_nature_naturesblessing"),
        maxRank: 1,
        reqPoints: 20,
      ...
      "Moonkin Form": {
        name: "Moonkin Form",
        pos: "g2",
        icon: ic("spell_nature_forceofnature"),
        maxRank: 1,
        reqPoints: 30,
  ...
  "Feral Combat": {
    name: "Feral Combat",
    background: bg("feral"),
    icon: ic("ability_racial_bearform"),
    talents: {
      Ferocity: {
        name: "Ferocity",
        pos: "a2",
        icon: ic("ability_hunter_pet_hyena"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Feline Swiftness": {
        ...
        pos: "c1",
        icon: ic("spell_nature_spiritwolf"),
        maxRank: 2,
        reqPoints: 10,
      ...
      "Feral Charge": {
        name: "Feral Charge",
        pos: "c2",
        icon: ic("ability_hunter_pet_bear"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Improved Shred": {
        name: "Improved Shred",
        pos: "d1",
        icon: ic("spell_shadow_vampiricaura"),
        maxRank: 2,
        reqPoints: 15,
      ...
      "Predatory Strikes": {
        ...
        pos: "d2",
        icon: ic("ability_hunter_pet_cat"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Primal Fury": {
        name: "Primal Fury",
        pos: "d4",
        icon: ic("ability_racial_cannibalize"),
        maxRank: 2,
        reqPoints: 15,
        prereq: "Sharpened Claws",
        arrows: [
      ...
      "Faerie Fire (Feral)": {
        ...
        pos: "e3",
        icon: ic("spell_nature_faeriefire"),
        maxRank: 1,
        reqPoints: 20,
      ...
      "Heart of the Wild": {
        ...
        pos: "f2",
        icon: ic("spell_holy_blessingofagility"),
        maxRank: 5,
        reqPoints: 25,
      ...
      "Leader of the Pack": {
        ...
        pos: "g2",
        icon: ic("spell_nature_unyeildingstamina"),
        maxRank: 1,
        reqPoints: 30,
  ...
  Restoration: {
    name: "Restoration",
    background: bg("restoration"),
    icon: ic("spell_nature_healingtouch"),
    talents: {
      "Improved Mark of the Wild": {
        name: "Improved Mark of the Wild",
        pos: "a2",
        icon: ic("spell_nature_regeneration"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Nature's Focus": {
        name: "Nature's Focus",
        pos: "b2",
        icon: ic("spell_nature_healingwavegreater"),
        maxRank: 5,
        reqPoints: 5,
        description: talentText`Gives you a ${[
          14,
      ...
      "Insect Swarm": {
        name: "Insect Swarm",
        pos: "c3",
        icon: ic("spell_nature_insectswarm"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Tranquil Spirit": {
        ...
        pos: "d2",
        icon: ic("spell_holy_elunesgrace"),
        maxRank: 5,
        reqPoints: 15,
      ...
      "Improved Rejuvenation": {
        ...
        pos: "d4",
        icon: ic("spell_nature_rejuvenation"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Gift of Nature": {
        name: "Gift of Nature",
        pos: "e3",
        icon: ic("spell_nature_protectionformnature"),
        maxRank: 5,
        reqPoints: 20,
        prereq: "Insect Swarm",
      ...
      "Improved Regrowth": {
        ...
        pos: "f3",
        icon: ic("spell_nature_resistnature"),
        maxRank: 5,
        reqPoints: 25,
      ...
      Swiftmend: {
        name: "Swiftmend",
        pos: "g2",
        icon: ic("inv_relics_idolofrejuvenation"),
        maxRank: 1,
        reqPoints: 30,
