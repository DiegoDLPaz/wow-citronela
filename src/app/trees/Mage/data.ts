...
export const data: TalentData = {
  Arcane: {
    name: "Arcane",
    background: bg("arcane"),
    icon: ic("spell_holy_magicalsentry"),
    talents: {
      "Arcane Subtlety": {
        name: "Arcane Subtlety",
        pos: "a1",
        icon: ic("spell_holy_dispelmagic"),
        maxRank: 2,
        reqPoints: 0,
      ...
      "Magic Absorption": {
        ...
        pos: "b2",
        icon: ic("spell_nature_astralrecalgroup"),
        maxRank: 5,
        reqPoints: 5,
      ...
      "Arcane Resilience": {
        ...
        pos: "c3",
        icon: ic("spell_arcane_arcaneresilience"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Improved Mana Shield": {
        ...
        pos: "d1",
        icon: ic("spell_shadow_detectlesserinvisibility"),
        maxRank: 2,
        reqPoints: 15,
  ...
  Fire: {
    ...
    talents: {
      ...
      Impact: {
        name: "Impact",
        pos: "a3",
        icon: ic("spell_fire_meteorstorm"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Master of Elements": {
        ...
        pos: "d4",
        icon: ic("spell_fire_masterofelements"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Blast Wave": {
        name: "Blast Wave",
        pos: "e3",
        icon: ic("spell_holy_excorcism_02"),
        maxRank: 1,
        reqPoints: 20,
        prereq: "Pyroblast",
        arrows: [{ dir: "down", from: "c3", to: "e3" }],
  ...
  Frost: {
    name: "Frost",
    background: bg("frost"),
    icon: ic("spell_frost_frostbolt02"),
    talents: {
      "Frost Warding": {
        name: "Frost Warding",
        pos: "a1",
      ...
      Frostbite: {
        name: "Frostbite",
        pos: "b2",
        icon: ic("spell_frost_frostarmor"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Improved Frost Nova": {
        ...
        pos: "b3",
        icon: ic("spell_frost_freezingbreath"),
        maxRank: 2,
        reqPoints: 5,
      ...
      Shatter: {
        name: "Shatter",
        pos: "d3",
        icon: ic("spell_frost_frostshock"),
        maxRank: 1,
        reqPoints: 15,
      ...
      "Winter's Chill": {
        name: "Winter's Chill",
        pos: "f3",
        icon: ic("spell_frost_chillingblast"),
        maxRank: 5,
        reqPoints: 25,
