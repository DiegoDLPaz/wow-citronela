...
export const data: TalentData = {
  Assassination: {
    name: "Assassination",
    background: bg("assassination"),
    icon: ic("ability_rogue_eviscerate"),
    talents: {
      "Improved Eviscerate": {
      ...
      Ruthlessness: {
        name: "Ruthlessness",
        pos: "b1",
        icon: ic("ability_druid_disembowel"),
        maxRank: 3,
        reqPoints: 5,
      ...
      Murder: {
        name: "Murder",
        pos: "b2",
        icon: ic("spell_shadow_deathscream"),
        maxRank: 2,
        reqPoints: 5,
      ...
      "Improved Slice and Dice": {
        ...
        pos: "b4",
        icon: ic("ability_rogue_slicedice"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Relentless Strikes": {
        ...
        pos: "c1",
        icon: ic("ability_warrior_decisivestrike"),
        maxRank: 1,
        reqPoints: 10,
      ...
      "Improved Expose Armor": {
        ...
        pos: "c2",
        icon: ic("ability_warrior_riposte"),
        maxRank: 2,
        reqPoints: 10,
      ...
      Lethality: {
        name: "Lethality",
        pos: "c3",
        icon: ic("ability_criticalstrike"),
        maxRank: 5,
        reqPoints: 10,
        prereq: "Malice",
      ...
      "Improved Kidney Shot": {
        ...
        pos: "e3",
        icon: ic("ability_rogue_kidneyshot"),
        maxRank: 3,
        reqPoints: 20,
  ...
  Combat: {
    name: "Combat",
    background: bg("combat"),
    icon: ic("ability_backstab"),
    talents: {
      "Improved Gouge": {
        name: "Improved Gouge",
        pos: "a1",
        icon: ic("ability_gouge"),
        maxRank: 3,
        reqPoints: 0,
      ...
      "Improved Sinister Strike": {
        ...
        pos: "a2",
        icon: ic("spell_shadow_ritualofsacrifice"),
        maxRank: 2,
        reqPoints: 0,
      ...
      "Dagger Specialization": {
        ...
        pos: "d2",
        icon: ic("inv_weapon_shortblade_05"),
        maxRank: 5,
        reqPoints: 15,
      ...
      "Blade Flurry": {
        name: "Blade Flurry",
        pos: "e2",
        icon: ic("ability_warrior_punishingblow"),
        maxRank: 1,
        reqPoints: 20,
      ...
      "Weapon Expertise": {
        ...
        pos: "f2",
        icon: ic("spell_holy_blessingofstrength"),
        maxRank: 2,
        reqPoints: 25,
        prereq: "Blade Flurry",
        arrows: [{ dir: "down", from: "e2", to: "f2" }],
      ...
      "Adrenaline Rush": {
        ...
        pos: "g2",
        icon: ic("spell_shadow_shadowworddominate"),
        maxRank: 1,
        reqPoints: 30,
  ...
  Subtlety: {
    name: "Subtlety",
    background: bg("subtlety"),
    icon: ic("ability_stealth"),
    talents: {
      "Master of Deception": {
        name: "Master of Deception",
        pos: "a2",
        icon: ic("spell_shadow_charm"),
        maxRank: 5,
        reqPoints: 0,
      ...
      Opportunity: {
        name: "Opportunity",
        pos: "a3",
        icon: ic("ability_warrior_warcry"),
        maxRank: 5,
        reqPoints: 0,
      ...
      Preparation: {
        name: "Preparation",
        pos: "e2",
        icon: ic("spell_shadow_antishadow"),
        maxRank: 1,
        reqPoints: 20,
      ...
      "Dirty Deeds": {
        name: "Dirty Deeds",
        pos: "e3",
        icon: ic("spell_shadow_summonsuccubus"),
        maxRank: 2,
        reqPoints: 20,
      ...
      Hemmorhage: {
        name: "Hemmorhage",
        pos: "e4",
        icon: ic("spell_shadow_lifedrain"),
        maxRank: 1,
        reqPoints: 20,
      ...
      Deadliness: {
        name: "Deadliness",
        pos: "f3",
        icon: ic("inv_weapon_crossbow_11"),
        maxRank: 5,
        reqPoints: 25,
      ...
      Premeditation: {
        name: "Premeditation",
        pos: "g2",
        icon: ic("spell_shadow_possession"),
        maxRank: 1,
        reqPoints: 30,
