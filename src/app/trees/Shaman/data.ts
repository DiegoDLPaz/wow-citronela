...
export const data: TalentData = {
  Elemental: {
    name: "Elemental",
    background: bg("elemental"),
    icon: ic("spell_nature_lightning"),
    talents: {
      Convection: {
        name: "Convection",
        pos: "a2",
      ...
      "Earth's Grasp": {
        name: "Earth's Grasp",
        pos: "b1",
        icon: ic("spell_nature_stoneclawtotem"),
        maxRank: 2,
        reqPoints: 5,
      ...
      "Elemental Warding": {
        ...
        pos: "b2",
        icon: ic("spell_nature_spiritarmor"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Call of Thunder": {
        ...
        pos: "c3",
        icon: ic("spell_nature_callstorm"),
        maxRank: 5,
        reqPoints: 10,
      ...
      "Eye of the Storm": {
        ...
        pos: "d2",
        icon: ic("spell_nature_eyeofthestorm"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Elemental Devastation": {
        ...
        pos: "d4",
        icon: ic("classic_spell_fire_elementaldevastation"),
        maxRank: 3,
        reqPoints: 15,
      ...
      "Storm Reach": {
        name: "Storm Reach",
        pos: "e1",
        icon: ic("spell_nature_stormreach"),
        maxRank: 2,
        reqPoints: 20,
      ...
      "Lightning Mastery": {
        ...
        pos: "f3",
        icon: ic("spell_lightning_lightningbolt01"),
        maxRank: 5,
        reqPoints: 25,
  ...
  Enhancement: {
    name: "Enhancement",
    background: bg("enhancement"),
    icon: ic("spell_nature_lightningshield"),
    talents: {
      "Ancestral Knowledge": {
        name: "Ancestral Knowledge",
        pos: "a2",
        icon: ic("spell_shadow_grimward"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Guardian Totems": {
        ...
        pos: "b1",
        icon: ic("spell_nature_stoneskintotem"),
        maxRank: 2,
        reqPoints: 5,
      ...
      "Enhancing Totems": {
        ...
        pos: "c1",
        icon: ic("spell_nature_earthbindtotem"),
        maxRank: 2,
        reqPoints: 10,
      ...
      Anticipation: {
        name: "Anticipation",
        pos: "c4",
        icon: ic("spell_nature_mirrorimage"),
        maxRank: 5,
        reqPoints: 10,
      ...
      "Improved Weapon Totems": {
        ...
        pos: "e1",
        icon: ic("spell_fire_enchantweapon"),
        maxRank: 2,
        reqPoints: 20,
      ...
      "Elemental Weapons": {
        ...
        pos: "e2",
        icon: ic("spell_fire_flametounge"),
        maxRank: 3,
        reqPoints: 20,
      ...
      Stormstrike: {
        name: "Stormstrike",
        pos: "g2",
        icon: ic("spell_holy_sealofmight"),
        maxRank: 1,
        reqPoints: 30,
  ...
  Restoration: {
    ...
    icon: ic("spell_nature_magicimmunity"),
    talents: {
      ...
      "Tidal Focus": {
        name: "Tidal Focus",
        pos: "a3",
        icon: ic("spell_frost_manarecharge"),
        maxRank: 5,
        reqPoints: 0,
      ...
      "Ancestral Healing": {
        ...
        pos: "b2",
        icon: ic("spell_nature_undyingstrength"),
        maxRank: 3,
        reqPoints: 5,
      ...
      "Healing Focus": {
        name: "Healing Focus",
        pos: "c2",
        icon: ic("spell_nature_healingwavelesser"),
        maxRank: 5,
        reqPoints: 10,
        description: talentText`Gives you a ${[
          14,
      ...
      "Healing Way": {
        name: "Healing Way",
        pos: "e1",
        icon: ic("classic_spell_nature_healingway"),
        maxRank: 3,
        reqPoints: 20,
      ...
      "Mana Tide Totem": {
        ...
        pos: "g2",
        icon: ic("spell_frost_summonwaterelemental"),
        maxRank: 1,
        reqPoints: 30,
